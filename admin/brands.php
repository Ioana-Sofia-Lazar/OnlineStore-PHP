...
if (isset($_GET['search-input'])) {
    ...
    $query = "SELECT * FROM brand WHERE id LIKE '%$search%' OR title LIKE '%$search%'";
}
...
?>
    ...
    <div id="products">
        ...
        <span id="buttons">
            <button type="button" onClick="window.location.href='brands.php';">Cancel</button>
            <button title="Click to save changes made on brands titles and to remove selected." type="submit" name="update-changes">Save Changes</button>
        </span>

        <table class="prod-table">
            <caption>Manage Brands</caption>
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Title</th>
...
?>
                <tr height="80px">
                    ...
                    <td>
                        <button title="Click to add a new Brand" type="submit" name="add-brand">Add Brand</button>
                    </td>
                </tr>
